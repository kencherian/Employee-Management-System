...
describe("SummaryCard Component", () => {
  ...
  it("renders the text passed as a prop correctly", () => {
    render(
      <SummaryCard text="Total Employees" number={10} color="bg-teal-600" />,
    );
  ...
  it("renders the number passed as a prop correctly", () => {
    render(
      <SummaryCard text="Total Employees" number={150} color="bg-teal-600" />,
    );
  ...
  it("applies the correct background color class dynamically", () => {
    const { container } = render(
      <SummaryCard text="Test" number={1} color="bg-red-600" />,
    );
  ...
  it("handles zero as a valid number without failing", () => {
    render(
      <SummaryCard text="Pending Leaves" number={0} color="bg-yellow-600" />,
    );
